...
load_data("sources/presentations.csv", ignore="date") %>%
  ...
  baretable(align=c("l", "l", "X"), tabular.environment = "xltabular", 
            caption="test caption", label="test label")

# TODO: Split by career stage, like with publications?
```

## TODO Posters & Abstracts
