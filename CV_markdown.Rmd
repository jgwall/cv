...
# cat("### ", "Associate Professor", " (", sum(pubs$period=="Associate Professor"), ")\n", sep="")
# pubs %>% filter(period=="Associate Professor")
# cat("### ", "Assistant Professor", " (", sum(pubs$period=="Assistant Professor"), ")\n", sep="")
# pubs %>% filter(period=="Assistant Professor")
