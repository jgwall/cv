...
for(myperiod in rev(unique(pubs$period))){
...
for(myperiod in rev(unique(presents$period))){
...
for(myperiod in rev(unique(posters$period))){
...
for(myperiod in rev(unique(funded$period))){
   cat("###", myperiod,"\n") 
...
for(myperiod in rev(unique(unfunded$period))){
   cat("###", myperiod,"\n") 
...
for(myperiod in rev(unique(reviews$period))){
   cat("####", myperiod,"\n") 
