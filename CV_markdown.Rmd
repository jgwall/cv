...
```{r}
# TODO: How to include publications? Keep list of DOIs and annotations?
# TODO: Want to make a nice table summary of pubs in different time periods
# Maybe list of DOIs and pull from CrossRef? Or can I somehow automatically pull?
```
